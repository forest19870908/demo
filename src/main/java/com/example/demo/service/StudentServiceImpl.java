...
public class StudentServiceImpl implements StudentService {
    ...
    public int saveStudent() {
        ...
        Integer age = 12;
        //执行写入
        int row = jdbcTemplate.update("INSERT INTO student (name,age)VALUES (?,?);", "张三", 12);
        //返回结果
        return row;
    }
    ...
    @Override
    public Map findById(String name,Integer id,Map param) {

        //SQL
        String sql = "SELECT *  FROM student WHERE id=?";
        //结果
        Map result = jdbcTemplate.queryForMap(sql,id);
        //返回结果
        return result;
    }
}